...
Development continues at **https://codeberg.org/araichev/mustaching**, so please file issues, pull requests, etc. there.This GitHub repository is archived.
---
...
Note to the maintainer: To update the docs do ``uv run publish-sphinx-docs``, then enter the docs remote ``git@github.com:araichev/mustaching_docs``.
